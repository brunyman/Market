...
public class UniversalMarket {
    ...
    public void onAboutToStart(GameInitializationEvent event) {
		...
		CommandSpec cmd = CommandSpec.builder().description(Text.of("Usage: /market")).arguments(GenericArguments.optional(GenericArguments.remainingJoinedStrings(Text.of("message")))).executor(new MarketCommand()).build();
        Sponge.getCommandManager().register(this, cmd, "market");
